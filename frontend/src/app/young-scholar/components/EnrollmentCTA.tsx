...
export default function EnrollmentCTA() {
  ...
  return (
    <section id="enrollment-cta" className="py-16 bg-white">
      <div className="container mx-auto max-w-4xl px-6">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card className="border border-gray-100 bg-slate-50 overflow-hidden rounded-[2.5rem] shadow-2xl">
            ...
            <CardContent className="p-10 md:p-16 text-center">
              ...
              <p className="text-base sm:text-lg text-gray-500 mb-10 max-w-xl mx-auto font-medium">
              ...
              <div className="flex justify-center">
                <Button
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white font-black uppercase tracking-widest px-10 py-7 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-xl shadow-red-600/20 text-sm"
                >
                  Enroll Now
                </Button>
              </div>
                ...
                <div className="flex flex-wrap justify-center gap-6 sm:gap-10">
                  {[
                    ...
                    <div key={i} className="flex flex-col items-center">
                      ...
                      <span className="text-xs font-bold text-gray-900 uppercase">{item.value}</span>
                    </div>
                  ))}
                </div>
              </div>
