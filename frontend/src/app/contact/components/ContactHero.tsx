        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
              Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-yellow-500">Touch</span>
            </h1>
            
            <p className="text-base sm:text-lg text-gray-400 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
